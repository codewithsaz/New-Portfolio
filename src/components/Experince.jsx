...
const Experince = () => {
  return (
    <div
      id="workflow"
      className="w-full  flex flex-col  items-center  dark:bg-[#000000] "
    >
      <div className=" inset-0 h-full w-full flex justify-center  bg-[radial-gradient(#313233_1px,transparent_1px)] dark:bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:36px_36px]">
        <div className="w-full lg:w-3/4 my-10 lg:my-20 flex justify-center items-center ">
          <div className=" w-full lg:w-3/4 flex flex-col gap-2  h-max p-4 backdrop-blur-sm">
              ...
              <TimelineItem>
                ...
                <TimelineBody className="pb-10">
                  ...
                  >
                    ...
                    consultation with the client to discuss their needs and
                    goals for the project. This helps me understand the scope of
                    the project and determine the best approach to take.
                  </Typography>
                </TimelineBody>
              </TimelineItem>
              <TimelineItem>
              ...
              <TimelineItem>
                ...
                <TimelineBody className="pb-10">
                  ...
                  >
                    ...
                    help visualize the layout and functionality of the website.
                    I work with the client to refine the design until it meets
              ...
              <TimelineItem>
                ...
                <TimelineBody className="pb-10">
                  ...
                  >
                    ...
                    into building robust server-side logic and APIs using
                    Node.js and Express.js, ensuring security and implementing
                    authentication.
                  </Typography>
                  <Typography
                    variant="small"
              ...
              <TimelineItem>
                ...
                <TimelineBody className="pb-10">
                  ...
                  >
                    ...
                    functionality, security and quality is working properly and
                    is free of errors.
                  </Typography>
                </TimelineBody>
              </TimelineItem>
              <TimelineItem>
                ...
                <TimelineBody className="pb-10">
                  ...
                  >
                    ...
                    deploy the application to a carefully chosen hosting
                    solution to make it live for the public to access. Optimize
                    for performance and incorporating monitoring and logging
                    tools.
                  </Typography>
                </TimelineBody>
              </TimelineItem>
              <TimelineItem>
                ...
                <TimelineBody>
                  <Typography
                    ...
                    className="font-normal text-gray-600"
                  >
                    After the website is launched, I may continue to work with
                    the client on an ongoing basis to provide maintenance and
                    updates as needed
                  </Typography>
                </TimelineBody>
              </TimelineItem>
