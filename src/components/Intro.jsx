...
const Intro = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-b from-[#ccaefc] to-[#fafafa]  dark:bg-gradient-to-b dark:from-[#272727]  dark:to-[#000000] mb-10    ">
      <div class=" inset-0 h-full w-full flex flex-col  items-center py-4  bg-[linear-gradient(to_right,#7041b512_1px,transparent_1px),linear-gradient(to_bottom,#7041b512_1px,transparent_1px)] dark:bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:36px_36px] pt-10">
        <div className=" lg:w-3/4 h-max flex flex-col justify-evenly items-center p-2  lg:flex-row-reverse gap-2 mt-14 pt-10 md:pt-20   ">
          <div className="w-full md:max-w-3xl h-full flex flex-col justify-center items-center text-center p-2 gap-1  ">
            <h1 className="text-3xl leading-tight font-bold  sm:text-5xl sm:leading-tight lg:text-7xl lg:leading-tight  mb-10 md:mb-14">
              Nice to meet you!👋
              <span class="relative inline-flex justify-center whitespace-nowrap font-bold decoration-accentPrimary underline underline-offset-4 sm:no-underline">
                <svg
                  class="absolute -bottom-8 hidden  w-2/3 text-accentPrimary sm:block"
                  viewBox="0 0 490 42"
                  fill="none"
            ...
            <Typography
              variant="lead"
              className="items-stretch text-center  text-lg font-sans "
            >
              A versatile software developer, passionate about crafting web and
            ...
            <div className=" w-full md:w-3/4 h-max flex gap-4 items-center my-2">
              <Button
                ...
                onClick={() => {
                  handleClick(
                    "https://drive.google.com/file/d/1LxTWa4ihSbvE8bwXOitO9LQ_AndIiVan/view?usp=drive_link"
                  );
                }}
              >
                View Resume
            ...
            <div class="mt-5 grid grid-cols-3 gap-6 divide-blue-200 md:grid-cols-3 md:gap-8 lg:mt-5 lg:grid-cols-3">
              <div class="">
